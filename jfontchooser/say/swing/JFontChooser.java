...
public class JFontChooser extends JComponent {
	private static final long serialVersionUID = -8465112409655162909L;
	// class variables
	/**
	...
	private static final String[] DEFAULT_FONT_SIZE_STRINGS = { "8", "9", "10", "11", "12", "14",
	...
	public JList<String> getFontFamilyList() {
		if (fontNameList == null) {
			...
			fontNameList
					.addListSelectionListener(new ListSelectionHandler(getFontFamilyTextField()));
	...
	public JList<String> getFontStyleList() {
		if (fontStyleList == null) {
			...
			fontStyleList
					.addListSelectionListener(new ListSelectionHandler(getFontStyleTextField()));
	...
	protected class DialogOKAction extends AbstractAction {
		private static final long serialVersionUID = -3343636614247551590L;
	...
	protected class DialogCancelAction extends AbstractAction {
		private static final long serialVersionUID = -5976502694414650909L;
	...
	protected JDialog createDialog(Component parent) {
		Frame frame = parent instanceof Frame ? (Frame) parent : (Frame) SwingUtilities
	...
	protected JTextField getSampleTextField() {
		if (sampleText == null) {
			...
			sampleText = new JTextField("Sample String");
